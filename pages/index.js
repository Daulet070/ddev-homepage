...
const Page = () => {
    return (
        <Container maxW="container.md" >
            ...
            <Box display={{ sm: 'flex' }} css={{ gap: '1.5rem' }} pt={{ base: 4, md: 4 }}>
                <Box
                    display='flex' 
                    flexShrink={0}
            ...
            <Section delay={0.1}>
                ...
                <Paragraph>
                    Daulet is a freelance and a frontend developer based in Nalchik
                    with a passion for building digital services. 
                    I love to learn and create things that are interesting and inspiring to me.
                    At the moment I have more than a year of experience in developing applications and sites and one completed commercial project
                </Paragraph>
            </Section>
            <Section delay={0.2}>
                <Heading as="h3" variant="section-title">
                ...
                <BioSection>
                    ...
                    Graduated from Kabardino-Balkarian State University with a degree in Mechatronics Robotics
                </BioSection>
                <BioSection>
